...
dataDir = 'C:/Users/xxxxx/OneDrive/Desktop/Thesis Repo/LSTM/'
#################################################################################
# Replace with your directory PATH and use forward/slashes/

mat = scipy.io.loadmat(dataDir+'Data/data_LSTM_23287_EW.mat')

X_data = mat['input_GM_23287_EW']
y_data = mat['target_X_23287_EW']
...
# Unknown data
X_pred = mat['input_pred_GM_23287_EW']
y_pred_ref = mat['target_pred_X_23287_EW']
...
with tf.device('/device:GPU:0'):
    ...
    for e in range(epochs):
        ...
        if test_loss[e] < best_loss:
            ...
            model.save(dataDir + 'Results/my_best_model-LSTM_23287_EW.h5')
...
# Load the best model
model_best = load_model(dataDir + 'Results/my_best_model-LSTM_23287_EW.h5')
...
X_pred_orig = mat['input_pred_GM_23287_EW']
y_pred_ref_orig = mat['target_pred_X_23287_EW']
...
# Save scaler
joblib.dump(scaler_X, dataDir+'Results/scaler_X-LSTM_23287_EW.save')
joblib.dump(scaler_y, dataDir+'Results/scaler_y-LSTM_23287_EW.save')


scipy.io.savemat(dataDir+'Results/results_LSTM_23287_EW.mat',

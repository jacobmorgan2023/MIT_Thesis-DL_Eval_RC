...
if __name__ == "__main__": 
    ...
    dataDir = 'C:/Users/xxxxx/OneDrive/Desktop/Thesis Repo/PhyLSTM/'   
    #################################################################################
    # Replace with your directory PATH and use forward/slashes/

    mat = scipy.io.loadmat(dataDir + 'Data/data_PHY_23287_EW.mat')
    # Complete with your directory PATH and use forward/slashes/
    ...
    ag_data = mat['input_GM_23287_EW'][:, :]  # ag, ad, av
    u_data = mat['target_X_23287_EW'][:, :, 0]
    ut_data = mat['target_Xd_23287_EW'][:, :, 0]
    utt_data = mat['target_Xdd_23287_EW'][:, :, 0]
    ...
    ag_pred = mat['input_pred_GM_23287_EW'][4:6, :]  # ag, ad, av
    u_pred = mat['target_pred_X_23287_EW'][4:6, :, 0]
    ut_pred = mat['target_pred_Xd_23287_EW'][4:6, :, 0]
    utt_pred = mat['target_pred_Xdd_23287_EW'][4:6, :, 0]
...
with tf.device('/device:GPU:0'):
    ...
    Loss_u1, Loss_udot1, Loss_g1, Loss_ut_c1, Loss_gt_c1, Loss_e1, Loss1, Loss_val1, best_loss1 = model.train(num_epochs=5000, learning_rate=1e-3, bfgs=1)
    ...
    for ii in range(len(yt_pred_ref)): #Index_pred
        plt.figure()
...
scipy.io.savemat(dataDir + 'Results/results_PhyLSTM_23287_EW_3rdFloor_Copy1.mat',

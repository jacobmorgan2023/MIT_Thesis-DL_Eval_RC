...
if __name__ == "__main__": 
    ...
    u_data = mat['target_X_23287_EW'][:, :, 1]
    ut_data = mat['target_Xd_23287_EW'][:, :, 1]
    utt_data = mat['target_Xdd_23287_EW'][:, :, 1]
    ...
    ag_pred = mat['input_pred_GM_23287_EW'][5:7, :]  # ag, ad, av
    u_pred = mat['target_pred_X_23287_EW'][5:7, :, 1]
    ut_pred = mat['target_pred_Xd_23287_EW'][5:7, :, 1]
    utt_pred = mat['target_pred_Xdd_23287_EW'][5:7, :, 1]
...
scipy.io.savemat(dataDir + 'Results/results_PhyLSTM_23287_EW_Roof.mat',
